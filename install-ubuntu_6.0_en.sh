...
echo "
+----------------------------------------------------------------------
| aaPanel 6.x FOR Ubuntu/Debian
+----------------------------------------------------------------------
| Copyright © 2015-2019 aaPanel(http://www.aapanel.com) All rights reserved.
+----------------------------------------------------------------------
...
if [[ "${deepinSys}" =~ eepin ]]; then
	...
	if [ -f "/etc/init.d/bt" ]; then
		...
		echo -e "=================================================================="
		echo -e "aaPanel: http://localhost:$port"
		echo -e "Default Account : admin"
		echo -e "Default Password: $password"
		echo -e "=================================================================="
		echo -e "Trying to open a browser..."
		...
		echo -e "Can't find chrome/firefox browser, please open your browser to access the aaPanel: http://loshost:$port"
		exit;
...
echo -e "=================================================================="
echo -e "aaPanel: http://$address:$port$auth_path"
