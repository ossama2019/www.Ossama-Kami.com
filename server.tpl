<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  <tr>
    <td align="left"><h1>Serverat Tuaj</h1></td>
  </tr>
</table>
{if $e_msg1}<div id="infobox"><strong>{$e_msg1}</strong><br />{$e_msg2}</div>{/if}
<table width="100%" cellpadding="1" cellspacing="1" class="container trans">
  <tr>
	<th width="26">#</th>
    <th width="50">Stanje</th>
    <th>Ime &amp; igra</th>
...
<table align="center">
  <tr>
    <td width="12" align="right"><table style="width:15px;height:13px;" cellspacing="1" class="data">
        <tr class="lgnd-pend">
          <td></td>
        </tr>
      </table></td>
