<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
  ...
  <tr>
    ...
    <td align="left"><h1>Web FTP</h1></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="right"><input type="button" value="Ktheu Mbrapa" onclick="window.location='serversummary.php?id={$srv.serverid}'" class="gbutton ggreen" /></td>
...
<table width="100%" cellpadding="2" cellspacing="1" class="data trans">
  ...
  <tr onmouseover="this.className='mouseover'" onmouseout="this.className=''">
    ...
    <td colspan="5"><b>Server još nije instaliran</b></td>
  ...
  <tr onmouseover="this.className='mouseover'" onmouseout="this.className=''">
    ...
    <td><a href="#" onclick="doDeleteDir('{$x.name}', '{$srv.serverid}', '{$path}')"><img src="templates/{$template}/images/buttons/red.png" width="25" height="25" alt="Obrisi" title="Obrisi" /></a></td>
    ...
    <td><form method="post" action="serverftpprocess.php" enctype="multipart/form-data">
        ...
        <table cellpadding="2" cellspacing="1" class="data">
          ...
          <tr>
            ...
            <th>Upload datoteke (Max: {$max_filesize})</th>
          ...
          <tr>
            ...
            <td><input type="submit" value="Upload" class="gbutton ggreen" /></td>
    ...
    <td><form method="post" action="serverftpprocess.php">
        ...
        <table cellpadding="2" cellspacing="1" class="data">
          ...
          <tr>
            ...
            <td align="center"><input type="submit" value="Napravi" class="gbutton ggreen" /></td>
...
function doDeleteFile(file, id, path) { if (confirm("Da li ste sigurni da želite obrisati datoteku: "+file+"?")) { window.location='serverftpprocess.php?task=filedelete&id='+id+'&path='+path+'&file='+file; } }

function doDeleteDir(dir, id, path) { if (confirm("Da li ste sigurni da želite obrisati fasciklu: "+dir+"?")) { window.location='serverftpprocess.php?task=dirdelete&id='+id+'&path='+path+'&dir='+dir; } }
...
<div align="center">
  ...
  <form method="post" action="serverftpprocess.php">
    ...
    <textarea name="filecontents" class="textarea2" rows="30" cols="150">{$file_contents}</textarea>

    <br />

    <img src="templates/{$template}/images/spacer.gif" height="10" width="1" alt="" /><br />

    <input type="submit" value="Saèuvaj" class="button green" />
